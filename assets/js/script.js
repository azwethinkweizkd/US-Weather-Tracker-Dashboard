...
function prevSearchCities() {
  // let listGroup = $("<ul>").addClass("list-group");
  // let prevCityList = $("<li>").addClass(
  //   "list-group-item list-group-item-light"
  // );
  let prevCityBtn = $("<button>")
    .addClass("p-2 btn searchBtn btn-dark mt-2 btn-block")
    .text(searchedCity);
  // listGroup.append(prevCityList);
  // prevCityList.append(prevCityBtn);
...
function getAPI() {
  ...
  fetch(requestURL)
    ...
    .then(function (data) {
      ...
      let cityName = $("<h4>")
        .addClass("p-2")
        .text(data.city.name + " " + today);
      // let wind = $("<p>")
      //   .addClass("p-2")
      //   .text(data.list.wind.speed + "mph");
